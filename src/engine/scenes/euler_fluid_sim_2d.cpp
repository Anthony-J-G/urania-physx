#include "euler_fluid_sim_2d.hpp"
#include "sample.hpp"
#include "scene.hpp"
...
Scene_API GenerateEulerFluidSim2D() {
    return Scene_API{
        .name = "EulerFluidSimulation2D",
        .initialize_fn = InitializeScene,
        .shutdown_fn = ShutdownScene,
        .update_fn = UpdateScene,
        .render_fn = RenderScene,
    };
}
