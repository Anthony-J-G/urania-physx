...
static int TextEditCallbackStub(ImGuiInputTextCallbackData* data) {
    CompilerWindow* console = (CompilerWindow*)data->UserData;
...
void CompilerWindow::Shutdown() {
}


void CompilerWindow::Update() {
}


void CompilerWindow::ClearLog() {
...
void CompilerWindow::AddLog(const char* fmt, ...) {
    // FIXME-OPT
    char buf[1024];
    va_list args;
    va_start(args, fmt);
...
void CompilerWindow::ExecCommand(const char* command_line) {
    AddLog("# %s\n", command_line);
...
int CompilerWindow::TextEditCallback(ImGuiInputTextCallbackData* data) {
